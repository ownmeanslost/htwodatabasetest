...
(function (factory) {
    ...
    var NAMESPACE, MODAL_ID, FRAMES, SORT_CSS, STYLE_SETTING, OBJECT_PARAMS, DEFAULT_PREVIEW, objUrl, compare, handler,
        ...
        tFooter, tActions, tActionDelete, tActionUpload,tActionDownload,tActionSeal,tActionViewimg, tActionZoom, tActionDrag, tTagBef, tTagBef1, tTagBef2, tTagAft,
    ...
    defaultFileActionSettings = {
        ...
        showZoom: true,
        showDrag: true,
        removeIcon: '<i class="anticon icon-delete"></i>',
        removeClass: 'btn btn-xs btn-default',
        removeTitle: 'Remove file',
        uploadIcon: '<i class="anticon icon-upload"></i>',
        uploadClass: 'btn btn-xs btn-default',
        uploadTitle: 'Upload file',
        downloadIcon: '<i class="anticon icon-download"></i>',
        downloadClass: 'btn btn-xs btn-default',
        downloadTitle: 'download file',
        sealIcon: '<i class="icon-seal"></i>',
        sealClass: 'btn btn-xs btn-default',
        sealTitle: 'seal file',
        viewimgIcon: '<i class="anticon icon-eyeo"></i>',
        viewimgClass: 'btn btn-xs btn-default',
        viewimgTitle: 'view',
    ...
    tFileIcon = '<i class="anticon icon-filetext1"></i> ';
    ...
    tActions = '<div class="file-actions">\n' +
        ...
        '        {upload} {download} {seal} {delete} {viewimg} {zoom} {other}' +
        '    </div>\n' +
        '    {drag}\n' +
    ...
    tActionDownload = '<button type="button" class="kv-file-download {downloadClass}" title="{downloadTitle}">' +
        '{downloadIcon}</button>';
    tActionSeal = '<button type="button" class="kv-file-seal {sealClass}" title="{sealTitle}">' +
        '{sealIcon}</button>';
    tActionViewimg = '<button type="button" class="kv-file-viewimg {viewimgClass}" title="{viewimgTitle}">' +
        '{viewimgIcon}</button>';
    ...
    defaultLayoutTemplates = {
        ...
        actionSeal: tActionSeal,
        actionViewimg: tActionViewimg,
    ...
    FileInput.prototype = {
        ...
        _renderFileActions: function (showUpload, showDelete, showZoom, showDrag, disabled, url, key, isInit) {
            ...
            var self = this,
                ...
                btnDelete = '', btnUpload = '', btnDownload = '',btnSeal = '',btnViewimg = '', btnZoom = '', btnDrag = '', css,
            ...
            if (config.showDownload) {
                btnDownload = self._getLayoutTemplate('actionDownload')
                    .replace(/\{downloadClass}/g, config.downloadClass)
                    .replace(/\{downloadIcon}/g, config.downloadIcon)
                    .replace(/\{downloadTitle}/g, config.downloadTitle);
            }
            if (config.showSeal) {
                btnSeal = self._getLayoutTemplate('actionSeal')
                    .replace(/\{sealClass}/g, config.sealClass)
                    .replace(/\{sealIcon}/g, config.sealIcon)
                    .replace(/\{sealTitle}/g, config.sealTitle);
            }
            if (config.showViewimg) {
                btnViewimg = self._getLayoutTemplate('actionViewimg')
                    .replace(/\{viewimgClass}/g, config.viewimgClass)
                    .replace(/\{viewimgIcon}/g, config.viewimgIcon)
                    .replace(/\{viewimgTitle}/g, config.viewimgTitle);
            }
            if (showZoom) {
            ...
            return template.replace(/\{delete}/g, btnDelete)
                ...
                .replace(/\{seal}/g, btnSeal)
                .replace(/\{viewimg}/g, btnViewimg)
    ...
    $.fn.fileinput.defaults = {
        ...
        previewFileIcon: '<i class="anticon icon-filetext1"></i>',
        previewFileIconClass: 'file-other-icon',
        previewFileIconSettings: {},
        previewFileExtSettings: {},
        buttonLabelClass: 'hidden-xs',
        browseIcon: '<i class="anticon icon-filetext1"></i>&nbsp;',
        browseClass: 'btn btn-primary',
        removeIcon: '<i class="anticon icon-delete"></i>',
        removeClass: 'btn btn-default',
        cancelIcon: '<i class="anticon icon-close"></i>',
        cancelClass: 'btn btn-default',
        uploadIcon: '<i class="anticon icon-upload"></i></i>',
        ...
        msgValidationErrorIcon: '<i class="anticon icon-filetext1"></i> ',
